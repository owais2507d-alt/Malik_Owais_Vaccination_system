        ...
        <div class="grid md:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden" 
            ...
            <div class="relative p-8 md:p-10 lg:p-12 bg-white">
                ...
                <div class="relative text-center md:text-left mb-8">
                    ...
                    <h2 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Patient Login</h2>
                    <p class="text-gray-500 text-sm mt-1">Access your health dashboard</p>
                    
                    {{-- Badge --}}
                    <div class="inline-flex items-center gap-1.5 mt-3 px-3 py-1 bg-blue-50 border border-blue-200 rounded-full">
                        <span class="w-1.5 h-1.5 bg-blue-500 rounded-full animate-pulse"></span>
                        <span class="text-xs font-medium text-blue-700">Patient Portal</span>
                    </div>
                </div>

                {{-- Form --}}
                <form method="POST" action="{{ route('patient.login.submit') }}" class="relative space-y-4">
                    @csrf
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer group">
                            <input type="checkbox" name="remember" 
                                   class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-400 focus:ring-offset-0 
                                          transition group-hover:border-blue-400">
                    ...
                    <div class="text-center text-sm text-gray-500">
                        ...
                        <a href="{{ route('patient.register') }}" class="text-blue-600 font-medium hover:text-blue-700 hover:underline transition">
                            Register as Patient
                        </a>
                    </div>
            ...
            <div class="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-indigo-700 p-8 md:p-10 lg:p-12 flex items-center justify-center overflow-hidden">
                ...
                <div class="relative text-center text-white z-10">
                    ...
                    <h3 class="text-2xl md:text-3xl font-bold mb-3">Patient Dashboard</h3>
                    <p class="text-blue-100/90 text-sm max-w-xs mx-auto leading-relaxed">
                        Book appointments, track test results, and manage your vaccination status in one place.
                    </p>
                    ...
                    <div class="mt-6 space-y-3 text-left max-w-xs mx-auto">
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                            ...
                            <span class="text-sm text-blue-50">Search &amp; book appointments</span>
                        </div>
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                            <svg class="w-5 h-5 text-blue-200 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        ...
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                            ...
                            <span class="text-sm text-blue-50">Secure profile management</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/10">
                        ...
                        <span class="text-xs text-blue-100/70">Patient Portal v2.0</span>
                    </div>
                </div>
            </div>
        </div>

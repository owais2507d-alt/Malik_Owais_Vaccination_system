        ...
        <div class="grid md:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden" 
            ...
            <div class="relative p-8 md:p-10 lg:p-12 bg-white">
                ...
                <div class="relative text-center md:text-left mb-8">
                    ...
                    <h2 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Register Hospital</h2>
                    <p class="text-gray-500 text-sm mt-1">Join our healthcare network</p>
                    
                    {{-- Badge --}}
                    <div class="inline-flex items-center gap-1.5 mt-3 px-3 py-1 bg-amber-50 border border-amber-200 rounded-full">
                        <span class="w-1.5 h-1.5 bg-amber-500 rounded-full animate-pulse"></span>
                        <span class="text-xs font-medium text-amber-700">Awaiting Admin Approval</span>
                    </div>
                </div>

                {{-- Form --}}
                <form method="POST" action="{{ route('hospital.register.submit') }}" class="relative space-y-4">
                    @csrf
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <input type="text" name="hospital_name" required placeholder="City General Hospital"
                    ...
                    <div class="group">
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            <div class="flex-1 h-1 bg-gray-200 rounded-full overflow-hidden">
                                <div id="passwordStrength" class="h-full w-0 bg-emerald-500 rounded-full transition-all duration-300"></div>
                            </div>
                    ...
                    <div class="flex items-start gap-2.5 pt-1">
                        <input type="checkbox" id="terms" name="terms" required
                               class="w-4 h-4 mt-0.5 rounded border-gray-300 text-emerald-600 focus:ring-emerald-400 focus:ring-offset-0 
                                      transition cursor-pointer">
                        <label for="terms" class="text-sm text-gray-500 cursor-pointer leading-relaxed">
                            I agree to the 
                            <a href="#" class="text-emerald-600 font-medium hover:text-emerald-700 hover:underline">Terms of Service</a> 
                            and 
                            <a href="#" class="text-emerald-600 font-medium hover:text-emerald-700 hover:underline">Privacy Policy</a>
                        </label>
                    </div>
                    ...
                    <div class="text-center text-sm text-gray-500">
                        Already registered?
                        <a href="{{ route('hospital.login') }}" class="text-emerald-600 font-medium hover:text-emerald-700 hover:underline transition">
            ...
            {{-- RIGHT SIDE: Registration Banner --}}
            <div class="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-teal-700 p-8 md:p-10 lg:p-12 flex items-center justify-center overflow-hidden">
                ...
                <div class="relative text-center text-white z-10">
                    ...
                    <h3 class="text-2xl md:text-3xl font-bold mb-3">Join Our Network</h3>
                    <p class="text-emerald-100/90 text-sm max-w-xs mx-auto leading-relaxed">
                        Register your healthcare facility and start managing patient appointments, tests, and vaccinations.
                    </p>
                    ...
                    <div class="mt-6 space-y-3 text-left max-w-xs mx-auto">
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                            ...
                            <span class="text-sm text-emerald-50">Free registration &amp; setup</span>
                        </div>
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                            <svg class="w-5 h-5 text-emerald-200 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <span class="text-sm text-emerald-50">Reach more patients online</span>
                        </div>
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                            <svg class="w-5 h-5 text-emerald-200 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <span class="text-sm text-emerald-50">Digital patient management</span>
                        </div>
                        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                            <svg class="w-5 h-5 text-emerald-200 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <span class="text-sm text-emerald-50">Real-time analytics &amp; reports</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/10">
                        ...
                        <span class="text-xs text-emerald-100/70">Admin approval required</span>
                    </div>
                </div>
            </div>
        </div>
...
document.querySelector('input[name="password"]').addEventListener('input', function() {
    ...
    const colors = ['bg-red-500', 'bg-red-500', 'bg-amber-500', 'bg-emerald-400', 'bg-emerald-500'];
    ...
    strengthText.className = `text-xs min-w-[60px] text-right ${strength >= 3 ? 'text-emerald-600' : 'text-gray-400'}`;
});
